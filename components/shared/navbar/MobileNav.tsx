        ...
        return (
          <SheetClose asChild key={item.route}>
            ...
            <Link
              ...
              className={`${
                isPremiumActive
                  ? "premium-gradient dark:premium-gradient-dark rounded-lg text-light-900 dark:text-light-900"
                  : isActive
        ...
        <div className="no-scrollbar flex h-[calc(100vh-80px)] flex-col justify-between overflow-y-auto">
          ...
          <SignedOut>
            <div className="flex flex-col gap-3">
              ...
              <SheetClose asChild>
                <Link href="/sign-up">
                  <Button className="small-medium btn-tertiary min-h-[41px] w-full rounded-lg px-4 py-3 text-purple-600 shadow-none dark:text-white">
                    Sign Up
                  </Button>
                </Link>
              </SheetClose>

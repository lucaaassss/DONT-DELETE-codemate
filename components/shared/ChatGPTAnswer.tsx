  ...
  return (
    <div className="gap-5 sm:flex-row sm:items-center sm:gap-2">
      <div className="flex flex-col items-center justify-center">
        <Button
          className="shinegenerate mt-10 gap-1.5 rounded-md border-2 border-white px-[80px] py-2.5 text-black shadow-none dark:text-white"
            ...
            >
              <>
                <Image
                  ...
                  width={14}
                  height={14}
                  className="invert-colors max-md:flip-vertical max-sm:flip-vertical sm:unflip-vertical xs:unflip-vertical max-xs:unflip-vertical object-contain"

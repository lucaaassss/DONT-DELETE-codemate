    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-6">
        {sidebarLinks.map((item) => {
          ...
          // check if the route is "/ask-question" and apply gold color if it is active
      ...
      <SignedOut>
        <div className="flex flex-col gap-3">
          ...
          <Link href="/sign-up">
            <Button className="small-medium light-border-2 btn-tertiary min-h-[41px] w-full rounded-lg px-4 py-3 text-purple-600 shadow-none dark:text-white">
              <Image
